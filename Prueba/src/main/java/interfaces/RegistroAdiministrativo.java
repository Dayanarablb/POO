 ...
 * @author ESPE
 */
public class RegistroAdiministrativo extends javax.swing.JFrame {

    /**
     * Creates new form RegistroAdiministrativo
     */
    public RegistroAdiministrativo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        PanelPrimero.setBackground(new java.awt.Color(255, 255, 255));
        PanelPrimero.setMaximumSize(new java.awt.Dimension(1200, 630));
        PanelPrimero.setPreferredSize(new java.awt.Dimension(1200, 630));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/lineas-abstractas-onda-suave-verde (1).jpg"))); // NOI18N
        ...
        getContentPane().add(PanelPrimero, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroAdiministrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroAdiministrativo().setVisible(true);
            }
        });
    }
